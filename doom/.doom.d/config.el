...
(setq auto-save-default nil)      ; disable #file# auto-saves
(setq make-backup-files nil)      ; disable file~ backups
(setq create-lockfiles nil)       ; disable .#file lock files
...
;; Set up python lsp
(after! lsp-mode
  (setq lsp-disabled-clients '(pylsp pyls ruff semgrep-ls ty-ls))
